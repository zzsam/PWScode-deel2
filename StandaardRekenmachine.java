...
//--------------------------------------------------------------------Nummer Buttons---------------------------------------------------------------------------		
		...
		button_decimalen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				decimaalClick=1;//zorgt ervoor dat je alleen 1 keer het punt-knopje kan klikken
			}
			}
		});
		...
		JButton Wortel = new JButton("\u221A"); // werkt nog niet
		Wortel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textField.setText(textField.getText()+Wortel.getText());
				wortelClick=1;
			}
		});
		...
		JButton Kwadraat = new JButton("^2");//werkt  nog niet
		Kwadraat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textField.setText("");
				teken = "^2"; 
		...
		Kwadraat.setFont(new Font("Tahoma", Font.PLAIN, 10));
		Kwadraat.setBounds(250, 200, 50, 40);
		frmStandaardRekenmachine.getContentPane().add(Kwadraat);
//--------------------------------------------------------------------Reken Methodes(=) ---------------------------------------------------------------------------		
		...
		Resultaat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else if (teken == "^2"){// dit werkt nog niet
